...
Pinterest advertising report project. Use this project to document Pinterest campaign results, audience behavior, and creative performance.

## Project Status

This folder is a documentation-ready shell for the private Power BI file:

- Source PBIX: Pinterest AD Reports.pbix
- Original private location: D:\Projects\Private-DataPlatform\powerbi_projects\publish\Pinterest AD Reports.pbix
- PBIX exists in private source: True
- Private PBIX size: 178708 bytes
...
Primary feeder script(s): pinterest_daily.py
